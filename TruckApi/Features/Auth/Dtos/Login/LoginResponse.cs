...
/// <param name="RefreshToken">Token para renovar o access token sem novo login.</param>
/// <param name="User">Dados do usuário autenticado.</param>
public record LoginResponse(string Token, string RefreshToken, UserSession User);
